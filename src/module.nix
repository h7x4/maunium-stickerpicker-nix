...
in {
  # TODO:
  # - consistent naming: stickerpacks -> stickerPacks
  options.services.maunium-stickerpicker = let
    inherit (lib) mkEnableOption mkOption types mkIf literalExpression mdDoc;
    ...
    stickerPackType = types.submodule ({ config, ... }: {
      ...
      options = {
        ...
        stickers = mkOption {
          ...
          '';
          description = mdDoc ''
            Json-like attrset or path to json file describing the stickerpacks contents.
          '';
        };
        ...
        generateTitle = mkOption {
          type = with types; functionTo (functionTo string);
      ...
      description = mdDoc "A stickerpack that should be fetched from a JSON file";
